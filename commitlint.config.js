/** @type {import('@commitlint/types').UserConfig & { prompt?: import('cz-git').UserConfig['prompt'] }} */
const Configuration = {
  ...
  prompt: {
    ...
    themeColorCode: "",
    scopes: [
      { value: "core", name: "core:       核心逻辑" },
      { value: "extension", name: "extension:  扩展主文件" },
      { value: "utils", name: "utils:      工具函数" },
      { value: "types", name: "types:      类型定义" },
      { value: "config", name: "config:     配置文件" },
      { value: "deps", name: "deps:       依赖项" },
